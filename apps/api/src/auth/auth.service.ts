...
import { ApiCommonService } from '@libs/api-common';
...
export class AuthService {
  ...
  public async signUp(
    ...
    return this.apiCommonService.successTimestamp<undefined, AuthTokenDataDto>({
      data: {
  ...
  public async updateEmail(
    ...
    return this.apiCommonService.successTimestamp();
  }
